...
# Aplicação de botões ao código:
co1, co2 = st.columns(2)

with co1:
    selected = option_menu(
        menu_title=None,
        options=['Análise específica', 'Análise geral'],
        default_index=0,
...
if selected == 'Análise geral':
    ...
    new = option_menu(
        menu_title=None,
        options=['Análise de frequência e média: valor e número de exames',
                 'Análise de evolução mensal: valor e número de exames',
                 'Análise da participação dos convênios'],
        orientation='horizontal',
    ...
    if new == 'Análise de frequência e média: valor e número de exames':
    ...
    if new == 'Análise de evolução mensal: valor e número de exames':
    ...
    if new == 'Análise da participação dos convênios':
